...
void LI_Init::push_ALL_IMU_CalibState(const sensor_msgs::msg::Imu::ConstPtr &msg, const double &mean_acc_norm) {
    CalibState IMUstate;
    ...
    IMUstate.timeStamp = msg->header.stamp.sec + msg->header.stamp.nanosec * 1e-9;
